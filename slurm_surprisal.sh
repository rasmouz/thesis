...
repo_home=/home/${USER}
src_path=${repo_home}/results
mkdir -p ${src_path}/surprisal
...
rsync --archive --update --compress --progress ${repo_home}/data/grammaticality_test/ ${dest_path}
...
dest_path=${repo_home}/results/surprisal
rsync --archive --update --compress --progress ${src_path}/ ${dest_path}
